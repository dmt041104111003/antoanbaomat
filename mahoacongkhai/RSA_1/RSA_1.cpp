...
main() {
    ...
    long long C = habac(M, d, n);
    cout << "An ma hoa cua M = " << M << ": " << C << std::endl;
 
    long long decrypted_M = habac(C, e, n);
    cout << "Giai ma ban ma: " << decrypted_M << std::endl;

    cout << "Viec ma hoa o cau c la thuc hien nhiem vu chu ky so." << std::endl;
